...
_SYSTEM_PROMPT = (
    ...
    "If the web_hits array is empty, rely on your legal and technical knowledge to suggest likely experts, "
    "citing reputable online sources they are associated with."
)
...
def _build_messages(web_hits: List[Dict[str, Any]], user_context: Dict[str, Any]) -> List[Dict[str, str]]:
    ...
    if not web_hits:
        instructions["fallback"] = (
            "No external search results were available. Provide thoughtful, well-researched candidates based on domain knowledge and cite authoritative sources."
        )
